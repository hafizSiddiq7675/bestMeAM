    ...
    public partial class frmSale : MetroFramework.Forms.MetroForm
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            if (lblSearch.Text == "")
            {
                ...
                dgvDetails.Rows.Add(i + 1, txtComodity.Text, txtContainerNo.Text, Convert.ToDecimal(txtQuantity.Text), Convert.ToDecimal(txtWeight.Text), Convert.ToDecimal(txtRate.Text), amt);
                decimal sum = 0;
        ...
        private void dgvDetails_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgv.CurrentRow.Selected)
            {
                ...
                lblSearch.Text = dgv.Rows[e.RowIndex].Cells["srNo"].Value.ToString();
                lblSearch.Hide();
                btnAdd.Text = "&Edit";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            im.companyName = cmbCompany.SelectedText;
